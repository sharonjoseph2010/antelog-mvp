DROP FUNCTION IF EXISTS public.get_response_tree(UUID);
...
BEGIN
  ...
  guest_with_parent AS (
    SELECT
      ...
      CASE
        ...
        WHEN sl.generated_by_name IS NOT NULL THEN (
  ...
  all_nodes AS (
    SELECT
      ...
      awp.is_antelog_user,
      awp.is_root,
      awp.user_id AS antelog_user_id,
      NULL::UUID AS guest_share_link_id

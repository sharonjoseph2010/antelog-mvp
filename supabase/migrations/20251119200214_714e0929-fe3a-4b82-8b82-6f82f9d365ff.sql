-- Update handle_user_signup trigger to extract phone number from auth metadata
...
BEGIN
  ...
  -- Create profile for new user with phone number
  ...
  VALUES (
    NEW.id,
    generated_handle,
    user_phone, -- Extract phone from auth metadata

-- Fix contact matching to work with profiles that don't have full_name
-- The issue is that the function was filtering out profiles without full_name
-- But we should match based on phone number alone, regardless of profile completeness
